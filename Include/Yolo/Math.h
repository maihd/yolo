...
namespace Math
{
    ...
    inline Matrix4 Scalation(float x, float y, float z = 1.0f)
    {
        return {
            x, 0, 0, 0,
            0, y, 0, 0,
    ...
    inline Matrix4 Translation(float x, float y, float z = 0.0f)
    {
        return {
            1, 0, 0, 0,
            0, 1, 0, 0,
    ...
    inline Matrix4 Transform2D(Vector2 position, float rotation, Vector2 scale, Vector2 pivot)
    {
