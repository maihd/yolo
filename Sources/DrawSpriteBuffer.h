...
namespace DrawSpriteBufferOps
{
    ...
    void                AddTexture(DrawSpriteBuffer* drawSpriteBuffer, Texture texture, Vector2 position, F32 rotation, Vector2 scale, Vector4 color, Vector2 pivot = Vector2{ 0.5f, 0.5f });
