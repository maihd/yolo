...
Texture Texture::New(const void* pixels, int width, int height, PixelFormat pixelsFormat, PixelFormat textureFormat)
{
    GLuint handle = 0;
...
Texture Texture::Load(string path)
{
    ...
    Texture texture = Texture::New(pixels, width, height, pixelsFormat, textureFormat);
