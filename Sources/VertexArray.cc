...
VertexArray VertexArray::New(void)
{
    GLuint handle;
...
void VertexArray::Free(VertexArray* vertexArray)
{
...
void VertexArray::SetIndexData(VertexArray vertexArray, const void* data, int size, BufferUsage usage)
{
...
void VertexArray::SetVertexData(VertexArray vertexArray, const void* data, int size, BufferUsage usage) 
{
    glBindVertexArray(vertexArray.handle);
...
void VertexArray::DefineAttribute(VertexArray vertexArray, int location, DataType type, int stride, int offset)
{
    if (location < 0)
    {
        return;
