...
void DrawTextBuffer::Free(DrawTextBuffer* drawBuffer)
{
    ...
    GLuint vertexBuffer = (GLuint)drawBuffer->vertexBuffer;
    GLuint indexBuffer = (GLuint)drawBuffer->indexBuffer;
    GLuint vertexArray = (GLuint)drawBuffer->vertexArray;
...
void DrawTextBuffer::UpdateBuffers(DrawTextBuffer* drawBuffer)
{
    ...
    if (drawBuffer->shouldUpdate)
    {
        ...
        if (!drawBuffer->vertexBuffer)
        {
            ...
            drawBuffer->vertexBuffer = vertexBuffer;
        }
        ...
        if (!drawBuffer->indexBuffer)
        {
            ...
            drawBuffer->indexBuffer = indexBuffer;
        }
        ...
        if (!drawBuffer->vertexArray)
        {
            ...
            drawBuffer->vertexArray = vertexArray;

            glBindVertexArray(vertexArray);
            glBindBuffer(GL_ARRAY_BUFFER, (GLuint)drawBuffer->vertexBuffer);
        ...
        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, (GLuint)drawBuffer->indexBuffer);
